...
from nnlib.training import metrics, callbacks
from nnlib.training.trainer import Trainer
from nnlib.data_utils.wrappers import ResizeImagesWrapper
from nnlib.data_utils.base import get_loaders_from_datasets, get_input_shape
from nnlib.data_utils.base import load_data_from_arguments
...
def main():
    ...
    model = StandardClassifier(input_shape=get_input_shape(train_loader.dataset),
